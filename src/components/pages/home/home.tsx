        ...
        <div className="flex min-h-screen flex-col items-center justify-between" style={{ backgroundColor: '#D9C4B3' }}>
            ...
            <main className="w-full  flex  flex-col">
                <section className="flex  px-[10%] py-65 flex-col gap-5">
                    <h1 className="text-8xl font-clash text-white">
                ...
                <section className="w-full flex justify-center bg-[#4B2E2B]">
                    <div className="flex  w-full py-50 px-[10%]  flex-col gap-10">
                ...
                <section className="flex w-full relative items-center h-[90vh] py-10 px-[10%] bg-[#D9C4B3] flex-col gap-[-30px]">
                    <h2 className="text-5xl right-90 top-30 absolute font-medium font-clash text-[#4B2E2B]">
                        Every great sip <br />
                        deserves a sidekick.
                    </h2>
                    <div className="absolute w-[55%]  aspect-[797/598]">
                        <Image
                            ...
                            alt={"#"}
                            className="absolute scale-70 object-cover"
                        />
                    </div>
                    <p className="font-clash left-90 bottom-15 absolute font-medium text-5xl text-[#4B2E2B]">
